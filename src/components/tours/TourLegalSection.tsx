...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      { content: '본 투어에는 기본 보험이 포함되지 않습니다. 보험은 예약 시 별도 선택 가능합니다 (₩10,000 이하).' },
      { label: '보상 한도', content: '최대 1억원 (상해, 후유장해, 사망)' },
      { label: '보험사', content: '추후 공개 예정 (약관 확인 후 고지)' },
      { label: '면책 사항', content: '본인 과실에 의한 사고, 음주 후 탑승, 교통법규 위반 등은 보험 보상에서 제외될 수 있습니다.' },
      { content: '보험 가입을 강력히 권장합니다. 가입하지 않을 경우 사고에 대한 책임은 참가자 본인에게 있습니다.' },
    ],
  },
  {
    icon: AlertTriangle,
  ...
  },
  {
    ...
    items: [
      ...
      { content: '집결 장소: 당산역 2번 출구 / 출발 10분 전까지 도착해주세요.' },
