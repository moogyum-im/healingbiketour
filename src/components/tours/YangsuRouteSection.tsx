...
const STOPS = [
  ...
  },
  {
    ...
    sub: '+7.5km · 세빛섬·분수 야경', sub_en: '+7.5km · Floating Islands & Fountain',
  ...
  {
    num: 4,
    name: '잠실 야경', name_en: 'Jamsil Night View',
    sub: '+9.5km · 잠실대교 야경 포인트', sub_en: '+9.5km · Jamsil Bridge night view',
    photo: '/stop-yangsu-jamsil-night.png',
    badge: { text: '19km', color: 'bg-blue-500' },
    size: 'two-third',
  },
  {
    num: 5,
    name: '미사리 조정경기장', name_en: 'Misari Regatta Course',
    sub: '+16km · 수상레포츠 명소', sub_en: '+16km · Water sports venue',
    photo: '/stop-yangsu-misari.png',
    badge: { text: '35km', color: 'bg-rose-500' },
    size: 'two-third',
  },
  {
    num: 6,
    name: '팔당댐', name_en: 'Paldang Dam',
    sub: '+4km · 팔당호 절경·산악 뷰', sub_en: '+4km · Paldang Lake panorama',
    photo: '/stop-yangsu-paldang.png',
    badge: { text: '39km', color: 'bg-orange-500' },
    size: 'third',
  },
  {
    num: 7,
    name: '세미원 다리', name_en: 'Semiwon Bridge',
    sub: '+8km · 아름다운 수생정원', sub_en: '+8km · Beautiful aquatic garden',
    photo: '/stop-yangsu-semiwon-bridge.png',
    badge: { text: '47km', color: 'bg-teal-500' },
    size: 'half',
  },
  {
    num: 8,
    name: '두물머리', name_en: 'Dumulmeori',
    sub: 'FINISH · 51km · 두 강이 만나는 비경', sub_en: 'FINISH · 51km · Where two rivers meet',
    photo: '/stop-yangsu-dumulmeori-dawn.png',
...
export default function YangsuRouteSection() {
  const locale = useLocale()
  const isKo = locale === 'ko'
    ...
    <section className="mt-10">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-2 rounded-full bg-zinc-900 px-4 py-2">
          ...
          <span className="text-sm font-black text-white">51km</span>
