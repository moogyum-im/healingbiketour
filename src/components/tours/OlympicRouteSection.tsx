...
const STOPS = [
  ...
  },
  {
    ...
    sub: '+3km · 한강버스 뷰포인트', sub_en: '+3km · Han River bus viewpoint',
  ...
  },
  {
    ...
    sub: '+7.5km · 세빛섬·분수 뷰포인트', sub_en: '+7.5km · Saebit Island & fountain view',
    photo: '/stop-olympic-banpo.png',
    badge: { text: '10.5km', color: 'bg-violet-500' },
  },
  {
    num: 4,
    name: '잠실운동장', name_en: 'Jamsil Stadium',
    sub: '+9km · 서울 동부 한강변', sub_en: '+9km · East Seoul riverside',
    photo: '/stop-olympic-jamsil.png',
    badge: { text: '19.5km', color: 'bg-rose-500' },
  },
  {
    num: 5,
    name: '올림픽공원', name_en: 'Olympic Park',
    sub: 'FINISH · 27km · 공원 내 자전거도로', sub_en: 'FINISH · 27km · Cycling paths through the park',
    ...
    <section className="mt-10">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-zinc-500">
        <span className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-emerald-500" />{isKo ? '출발·도착 (당산역 4번 출구)' : 'Start/End: Dangsan Station Exit 4'}
        </span>
        <span className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-violet-500" />{isKo ? '반포대교 한강라면 포인트' : 'Banpo Bridge ramen stop'}
        </span>
