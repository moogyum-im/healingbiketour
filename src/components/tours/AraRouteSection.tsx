    ...
    <section className="mt-10">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-2 rounded-full bg-zinc-900 px-4 py-2">
          ...
          <span className="text-sm font-black text-white">왕복 69km</span>
          <span className="text-xs text-zinc-400">/ 편도 34.5km</span>
        </div>
      </div>

      <div className="flex flex-col gap-2">

        {/* Row 1: 당산역(1/3) + 서울식물원(2/3) */}
      ...
      <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-zinc-500">
        <span className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-orange-400" />편도 종점 34.5km
        </span>
        <span className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-emerald-400" />왕복 완주 69km
        </span>
